...
const PostComposer = () => {
  ...
  const { user } = useUser();
  return (
    <View className="border-b border-gray-100 p-5 bg-white">
        ...
        <View className="mt-3 ml-15">
          <View className="relative">
            <Image
              ...
              resizeMode="cover"
            />
            <TouchableOpacity className="absolute top-2 right-2 w-8 h-8 bg-black/60 rounded-full items-center justify-center">
              <Feather name="x" size={16} color="white" onPress={removeImage} />
            </TouchableOpacity>
          </View>
        </View>
      )}
